...
public class Main {
    ...
    public static void Test1() {
        ...
        testClass = (TestClassInterface) Proxy.newProxyInstance(testClass.getClass().getClassLoader(),
                testClass.getClass().getInterfaces(), new Cacher(testClass, PgConnection.getInstance()));
